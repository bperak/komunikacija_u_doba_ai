...
Stvaranje uspješnog modela umjetne inteligencije je maraton, a ne sprint. To je kontinuirani ciklični proces učenja, prilagodbe i poboljšanja, duboko ukorijenjen u podacima iz kojih izvire i u primjeni kojoj služi.
...
U srcu predtreniranja leži načelo **samonadziranog učenja** (engl. *self-supervised learning*).

> **Samonadzirano učenje / self-supervised learning:** Način učenja u kojem model ne koristi ljudski označene podatke (parove ulaz–izlaz), već sam iz strukture podataka izvodi zadatak: npr. predviđa skriveni dio ulaza (sljedeću riječ, maskirani token) ili drugi izvedeni cilj. Signal za učenje dolazi iz samih podataka. Ovaj je postupak ključan za predtreniranje velikih jezičnih modela temeljem ogromnih količina korpusnih podataka za koje bi ručnog označavanje bilo teško izvedivo.
...
### 3.5.3		Optimizacija za stvarni svijet: efikasnost 
...
### 3.5.4 Mjerenje uspjeha: evaluacija 
