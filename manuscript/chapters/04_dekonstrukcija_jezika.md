...
Algoritamski uspostavljeni okviri značenja pokazuju znatnu podudarnost s **konceptualnim okvirima** koji, prema **kognitivnoj lingvistici**, oblikuju i ljudsko poimanje svijeta (Lakoff & Johnson, 1980).

> **Kognitivna lingvistika:** Grana lingvistike koja istražuje odnos jezika i uma; polazi od pretpostavke da je jezik uklopljen u opće kognitivne mehanizme i da jezično značenje proizlazi iz konceptualnih struktura, slika, metafora i iskustva tijelom (embodiment); ističe da naše poimanje svijeta nije neposredno zrcaljenje stvarnosti, već je oblikovano konceptualnim okvirima i jezičnim kategorijama (Lakoff & Johnson, 1980; Langacker, Talmy).
>
> **Konceptualni okvir:** Sustav povezanih pojmova, metafora i shema koji strukturiraju naše razumijevanje pojava i iskustava; prema kognitivnoj lingvistici ljudi ne percipiraju svijet „čisto“, već kroz takve okvire koji određuju što uočavamo, kako kategoriziramo i kako djelujemo; okviri su dio kulturne i jezične prakse (Lakoff & Johnson, 1980).

Ipak, postoji bitna razlika. Dok su ljudski spoznajni okviri plod složenoga prožimanja bioloških predispozicija, osobnog iskustva i kulturno-povijesnoga nasljeđa, algoritamski su okviri u potpunosti izvedeni iz statističkih zakonitosti prisutnih u podatkovnim skupovima. Slijedom toga svaka pristranost, svaka praznina ili prevlast određenih gledišta unutar tih podataka biva ne samo prenesena, već i pojačana, sustavno utisnuta u samu logiku agentova djelovanja. (Re)konstrukcija stvarnosti koju agent nudi nije dakle odraz stvarnosti kao takve, već odraz svijeta kakav je predstavljen u njegovim izvorišnim podacima.
